/* Gnome guardians laser turret computer script.
 *
...
function UpdateState()
{
	...
	if(g_ModeScript.OPTIMIZE_NETCODE)
	{
		...
		{
			if((turretScope.sweepCycle != 0 || turretScope.sweepFire) &&
				turretScope.heat > 150)
			{
